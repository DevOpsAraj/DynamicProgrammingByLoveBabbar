// Qn Link : https://www.codingninjas.com/codestudio/problems/0-1-knapsack_920542
...
int solveSpaceOpt1(vector<int> &weight, vector<int> &value, int n, int capacity){
...
//     return solveSpaceOpt1(weight, value, n, maxWeight);
    return solveSpaceOpt2(weight, value, n, maxWeight);
}
